...
MultipleChoice_func = function(question, dt = multipleChoiceResponses){
  ...
  # The output should be plotted and processed
}
...
Wordclourd_func = function(input, dt = freeformResponses){
  ...
  # for starters, word_freqs can be processed with wordcloud and barplot
}
...
Note that the question of tenure is directed to all, some students may have included their years of doing analysis in Education (university experiments etc), so this is probably not the best indicative of working exprerience.
...
As noted by other kernal, the respondents of the survey are young, most likely in their mid 20s.
